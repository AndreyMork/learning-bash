...
---
## `/bin`
Contains binaries that must be present for system to boot and run.
...
It also contains a collection of shell scripts which start each of the system services at boot time.
